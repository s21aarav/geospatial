...
export default function JobSidebar({ jobs, activeJobId, setActiveJobId, onNewUplink }) {
  return (
    <div className="fixed left-0 top-0 h-screen bg-black/30 backdrop-blur-sm border-r border-white/10 z-50 transition-all duration-300 ease-in-out w-16 hover:w-64 group/sidebar flex flex-col overflow-x-hidden shadow-lg">
